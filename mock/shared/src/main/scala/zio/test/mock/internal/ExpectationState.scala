...
private[mock] object ExpectationState {
  ...
  /**
   * Expectation that has been satisfied, but could potentially match further
   * calls.
   *
  ...
  /**
   * Expectation that has been satisfied and saturated - it cannot match further
   * calls. Will short-circuit and skip ahead to the next expectation when
   * looking for matches.
   *
   * The test will succeed, if it ends with expectation in this state.
   */
