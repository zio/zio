...
class QueueSpec(implicit ee: ExecutionEnv) extends AbstractRTSSpec with AroundTimeout {
  ...
  def is =
    ...
    offerAll does not preserve the order of the List ${upTo(1.second)(e28)}
    offerAll does not preserve the order of the List whe it exceeds the queue's capacity ${upTo(1.second)(e29)}
    """
