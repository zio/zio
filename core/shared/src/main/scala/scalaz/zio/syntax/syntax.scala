...
package object syntax {
  ...
  implicit final def ioIterableSyntax[E, A](ios: Iterable[BIO[E, A]]): IOIterableSyntax[E, A] =
    new IOIterableSyntax(ios)
  implicit final def ioTuple2Syntax[E, A, B](ios: (BIO[E, A], BIO[E, B])): IOTuple2[E, A, B] = new IOTuple2(ios)
  implicit final def ioTuple3Syntax[E, A, B, C](ios: (BIO[E, A], BIO[E, B], BIO[E, C])): IOTuple3[E, A, B, C] =
    new IOTuple3(ios)
