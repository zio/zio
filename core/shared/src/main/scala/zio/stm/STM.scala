...
object STM {
  ...
  /**
   * @see
   *   See [[[zio.stm.ZSTM.collectAll[R,E,A,Collection[+Element]<:Iterable[Element]] *]]]
   */
  ...
  /**
   * @see
   *   See [[[zio.stm.ZSTM.foreach[R,E,A,B,Collection[+Element]<:Iterable[Element]] *]]]
   */
  ...
  /**
   * @see
   *   See [[[zio.stm.ZSTM.validate[R,E,A,B,Collection[+Element]<:Iterable[Element]] *]]]
   */
