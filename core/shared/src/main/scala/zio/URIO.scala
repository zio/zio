...
object URIO {
   ...
   * @see [[zio.ZIO.ifM]]
   */
  def ifZIO[R](b: URIO[R, Boolean]): ZIO.IfM[R, Nothing] =
    ZIO.ifZIO(b)
   ...
   * @see See [[zio.ZIO.unlessM]]
   */
  def unlessZIO[R](b: URIO[R, Boolean]): ZIO.UnlessM[R, Nothing] =
    ZIO.unlessZIO(b)
   ...
   * @see [[zio.ZIO.whenM]]
   */
  def whenZIO[R](b: URIO[R, Boolean]): ZIO.WhenM[R, Nothing] =
    ZIO.whenZIO(b)
