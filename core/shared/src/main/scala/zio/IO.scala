...
object IO {
   ...
   */
  final def collectAllSuccessesParN[E, A](n: Long)(as: Iterable[IO[E, A]]): IO[E, List[A]] =
   ...
   */
  final def collectAllWithParN[E, A, B](n: Long)(as: Iterable[IO[E, A]])(f: PartialFunction[A, B]): IO[E, List[B]] =
