...
final case class LayerBuilder[Type, Expr](
   ...
   *
   * ==If [[method]] is not [[ProvideMethod.ProvideSomeShared]]==
   ...
   *
   * ==If [[method]] is [[ProvideMethod.ProvideSomeShared]]==
   *   - `In` will be AND'ed together types from [[remainder]]
   *   - `Err` will be the union of all errors in the provided layers
   ...
   *
   * ==If [[method]] is not [[ProvideMethod.ProvideSomeShared]]==
   *   - `In` will be some autogenerated type
   *   - `Err` will be the union of all errors in the provided layers
   *   - `Out` will be AND'ed together types from [[target0]]
   *
   * ==If [[method]] is [[ProvideMethod.ProvideSomeShared]]==
   *   - `In` will be some autogenerated type
   *   - `Err` will be the union of all errors in the provided layers
   *   - `Out` will be some autogenerated type
   *
   * And following relation exists: `In & Out` <:< AND'ed together types from [[target0]]
   */
  def buildAuto: Expr = {
    assertNoAmbiguity()
