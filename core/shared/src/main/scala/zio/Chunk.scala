 ...
 * types.
 */
sealed trait Chunk[+A] extends ChunkLike[A] with Serializable { self =>
  ...
  override def map[B](f: A => B): Chunk[B] =
    length match {
      case 0 =>
        Chunk.empty[B]
      case 1 =>
        Chunk.single(f(self(0)))
      case len =>
        var i  = 0
        val r0 = f(apply(i))

        val tag = Chunk.Tags.fromValue(r0)
...
object Chunk extends ChunkFactory with ChunkPlatformSpecific {
  ...
  def fromIterable[A](it: Iterable[A]): Chunk[A] =
    it match {
      ...
      case iterable if iterable.knownSize == 1 => Chunk.single(iterable.head)
      case vector: Vector[A]                   => VectorChunk(vector)
      case iterable =>
        ChunkBuilder
          .make[A](iterable.knownSize)
          .addAll(iterable)
          .result()
    }
  ...
  private[zio] sealed trait Arr[@specialized A] extends Chunk[A] with Serializable { self =>
  ...
  private final case class Concat[@specialized A](
    ...
    override def foreach[@specialized B](f: A => B): Unit = {
      left.foreach(f)
      right.foreach(f)
    }
  ...
  private final case class Slice[@specialized A](private val chunk: Chunk[A], offset: Int, l: Int) extends Chunk[A] {
  ...
  final case class ByteArray(array: Array[Byte], offset: Int, override val length: Int)
    ...
    def hasNextAt(index: Int): Boolean =
      index < length
    override def map[@specialized B](f: Byte => B): Chunk[B] =
      length match {
        case 0 =>
          Chunk.empty[B]
        case 1 =>
  ...
  final case class CharArray(array: Array[Char], offset: Int, override val length: Int)
    ...
    def hasNextAt(index: Int): Boolean =
      index < length
    override def map[@specialized B](f: Char => B): Chunk[B] =
      length match {
        case 0 =>
          Chunk.empty[B]
        case 1 =>
  ...
  final case class IntArray(array: Array[Int], offset: Int, override val length: Int)
    ...
    override def int(index: Int)(implicit ev: Int <:< Int): Int =
      array(index + offset)
    override def map[@specialized B](f: Int => B): Chunk[B] =
      length match {
        case 0 =>
          Chunk.empty[B]
        case 1 =>
  ...
  final case class LongArray(array: Array[Long], offset: Int, override val length: Int)
    ...
    override def long(index: Int)(implicit ev: Long <:< Long): Long =
      array(index + offset)
    override def map[@specialized B](f: Long => B): Chunk[B] =
      length match {
        case 0 =>
          Chunk.empty[B]
        case 1 =>
  ...
  final case class DoubleArray(array: Array[Double], offset: Int, override val length: Int)
    ...
    def hasNextAt(index: Int): Boolean =
      index < length
    override def map[@specialized B](f: Double => B): Chunk[B] =
      length match {
        case 0 =>
          Chunk.empty[B]
        case 1 =>
  ...
  final case class FloatArray(array: Array[Float], offset: Int, override val length: Int)
    ...
    def hasNextAt(index: Int): Boolean =
      index < length
    override def map[@specialized B](f: Float => B): Chunk[B] =
      length match {
        case 0 =>
          Chunk.empty[B]
        case 1 =>
  ...
  final case class ShortArray(array: Array[Short], offset: Int, override val length: Int)
    ...
    def hasNextAt(index: Int): Boolean =
      index < length
    override def map[@specialized B](f: Short => B): Chunk[B] =
      length match {
        case 0 =>
          Chunk.empty[B]
        case 1 =>
  ...
  final case class BooleanArray(array: Array[Boolean], offset: Int, length: Int)
    ...
    def hasNextAt(index: Int): Boolean =
      index < length
    override def map[@specialized B](f: Boolean => B): Chunk[B] =
      length match {
        case 0 =>
          Chunk.empty[B]
        case 1 =>
