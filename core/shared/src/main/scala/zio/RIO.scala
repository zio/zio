...
object RIO {
   ...
   * @see [[zio.ZIO.ifM]]
   */
  def ifZIO[R](b: RIO[R, Boolean]): ZIO.IfM[R, Throwable] =
    ZIO.ifZIO(b)
   ...
   * @see See [[zio.ZIO.unlessM]]
   */
  def unlessZIO[R](b: RIO[R, Boolean]): ZIO.UnlessM[R, Throwable] =
    ZIO.unlessZIO(b)
   ...
   * @see See [[zio.ZIO.whenM]]
   */
  def whenZIO[R](b: RIO[R, Boolean]): ZIO.WhenM[R, Throwable] =
    ZIO.whenZIO(b)
