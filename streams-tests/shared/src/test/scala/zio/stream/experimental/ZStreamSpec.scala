      ...
      suite("Combinators")(
        ...
        suite("groupAdjacentBy")(
          test("groupAdjacentBy 1")(check(Gen.chunkOf(Gen.chunkOf(Gen.int))) { iss =>
            ...
            ZStream.fromChunk(iss).flattenChunks.groupAdjacentBy(keyFn).runCollect.map { oss =>
              ...
              def verifyAdjacentKeys(in: Chunk[(Boolean, Any)]): Boolean =
                in.sliding(2, 1)
                  .foldLeft(true)((res, chunk) => res && (chunk.length == 1 || chunk(0)._1 != chunk(1)._1))
          ...
          test("groupAdjacentBy 2") {
            assertM(
              ZStream((1, 1), (1, 2), (1, 3), (2, 1), (2, 2), (1, 4)).groupAdjacentBy(_._1).runCollect
            )(
              equalTo(
                Chunk(
