  ...
  def spec =
    suite("StreamLazinessSpec")(
      ...
      suite("ZStream companion object")(
        ...
        lazy1("fromChunkQueue")(ZStream.fromChunkQueue(_)) @@ failing,
        lazy1("fromChunkQueueWithShutdown")(ZStream.fromChunkQueueWithShutdown(_)) @@ failing,
        ...
        lazy2("fromQueue")(ZStream.fromQueue(_, _)) @@ failing,
        lazy2("fromQueueWithShutdown")(ZStream.fromQueueWithShutdown(_, _)) @@ failing,
        lazy1("fromSchedule")(ZStream.fromSchedule(_)),
        lazy1("fromTPriorityQueue")(ZStream.fromTPriorityQueue(_)) @@ failing,
        lazy1("fromTQueue")(ZStream.fromTQueue(_)) @@ failing,
        ...
        lazy2("repeatWithSchedule")(ZStream.repeatWithSchedule(_, _)) @@ failing,
        lazy1("repeatZIO")(ZStream.repeatZIO(_)) @@ failing,
        lazy1("repeatZIOChunk")(ZStream.repeatZIOChunk(_)) @@ failing,
        lazy1("repeatZIOChunkOption")(ZStream.repeatZIOChunkOption(_)) @@ failing,
        lazy1("repeatZIOOption")(ZStream.repeatZIOOption(_)) @@ failing,
        lazy2("repeatZIOWithSchedule")(ZStream.repeatZIOWithSchedule(_, _)) @@ failing,
        ...
        lazy1("tick")(ZStream.tick(_)) @@ failing,
        lazy1[Int]("unfold")(e => ZStream.unfold(e)(s => Some((s, s)))),
        lazy1[Int]("unfoldChunk")(e => ZStream.unfoldChunk(e)(s => Some((Chunk(s), s)))),
        lazy1[Int]("unfoldChunkZIO")(e => ZStream.unfoldChunkZIO(e)(s => ZIO.succeed(Some((Chunk(s), s))))) @@ failing,
        lazy1[Int]("unfoldZIO")(e => ZStream.unfoldZIO(e)(s => ZIO.succeed(Some((s, s))))) @@ failing,
