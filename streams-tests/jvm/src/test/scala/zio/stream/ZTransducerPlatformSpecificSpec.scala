...
object ZTransducerPlatformSpecificSpec extends ZIOBaseSpec {
  ...
  private def readResourceAsString(fileName: String, transducer: ZTransducer[Blocking, IOException, Byte, String]) =
    ZStream
  ...
  override def spec: Spec[Has[Blocking.Service] with Has[Annotations.Service], TestFailure[Any], TestSuccess] =
    suite("ZSink JVM")(
      suite("fromFile")(
