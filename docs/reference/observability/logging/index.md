...
- **[ZLogger](zlogger.md)** — Reference documentation for `ZLogger[-Message, +Output]`: the composable functional logging interface, its combinators, predefined instances, and `ZTestLogger` for in-memory test capture.
