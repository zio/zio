...
Each library documentation source code is a node project that will be published to the npm registry. So the `package.json` file is required. The file is used to specify the name, description, and license of the documentation project. Example:
...
The `index.md` file is the main page of the documentation. It is used to describe the library and its features. The structure of this file is as follows:
...
The `index.md` is the main source of generating the `README.md` file of the library. We will discuss more about this in the [Autogenerated README File](#autogenerated-readme-file) section.
