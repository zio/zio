...
Also in ZIO 2.x instead of the `Has` data type, a type-level map called `ZEnvironment` has been added to ZIO. Let's see how this changes the way we can provide a service to the environment.
