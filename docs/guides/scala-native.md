---
id: scala-native
title: "Build and Run a ZIO Application on Scala Native"
description: "Configure sbt-crossproject to compile and link a ZIO application as a Scala Native binary without the JVM."
keywords:
  - "Scala Native"
  - "Cross Compilation"
  - "Native Binary"
...
lazy val myApp = crossProject(JVMPlatform, NativePlatform)
  ...
  .settings(
    ...
    libraryDependencies += "dev.zio" %%% "zio"         % "@VERSION@",
    libraryDependencies += "dev.zio" %%% "zio-streams"  % "@VERSION@",
    libraryDependencies += "dev.zio" %%% "zio-test"     % "@VERSION@" % Test,
    libraryDependencies += "dev.zio" %%% "zio-test-sbt" % "@VERSION@" % Test,
...
```scala mdoc:embed:zio-examples/scala-native/src/main/scala/scalanative/CompleteExample.scala
```
...
```scala mdoc:embed:zio-examples/scala-native/src/main/scala/scalanative/Main.scala:show-line-numbers
```
...
```scala mdoc:embed:zio-examples/scala-native/src/test/scala/scalanative/JobQueueSpec.scala:show-line-numbers
```
