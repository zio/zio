...
println(s"""```""")
println(s"""libraryDependencies += "dev.zio" %% "zio" % "${java.lang.System.getenv("ZIO_LATEST_2").replaceAll("v", "")}"""")
println(s"""```""")
```
...
```scala mdoc:passthrough
println(s"""```""")
println(s"""libraryDependencies += "dev.zio" %% "zio-streams" % "${java.lang.System.getenv("ZIO_LATEST_2").replaceAll("v", "")}"""")
println(s"""```""")
```
