...
//                 Module.umanaged(s)
//               def urmanaged(s: String): ZManaged[String with Has[Module], Nothing, Int] =
//                 Module.urmanaged(s)
//               def zmanaged(s: String): ZManaged[String with Has[Module], String, Int] =
//                 Module.zmanaged(s)
//             }
//           """
//         })(isRight(anything))
...
//               def sink(arg1: Int)                        : ZSink[Has[Module], Nothing, Int, Nothing, Int, List[Int]] = Module.sink(arg1)
