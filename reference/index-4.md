# Introduction to ZIO's Control Flow Operators

> Control-flow operators in ZIO: conditional branching (when, unless, cond), looping (loop, iterate, foreach), and resource bracketing.
