...
// msgLogger: ZLogger[String, Unit] = zio.ZLogger$$anon$6@5e158a82

// 2. Adapt it to accept integers as messages
val intLogger: ZLogger[Int, Unit] =
  msgLogger.contramap[Int](_.toString)
// intLogger: ZLogger[Int, Unit] = zio.ZLogger$$anon$2@1936d9ac
...
// warnLogger: ZLogger[String, Option[Unit]] = zio.ZLogger$$anon$3@3d6a4175
...
// sampleLine: String = "timestamp=2026-08-07T14:00:32.737967112Z level=INFO thread=#zio-fiber- message=\"something happened\""

// 5. Fan both loggers together; Zippable[String, Unit].Out = String
val combined: ZLogger[String, String] = ZLogger.default ++ msgLogger
// combined: ZLogger[String, String] = zio.ZLogger$$anon$1@241baea8
```
