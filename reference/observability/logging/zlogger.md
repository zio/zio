...
// msgLogger: ZLogger[String, Unit] = zio.ZLogger$$anon$6@50103832

// 2. Adapt it to accept integers as messages
val intLogger: ZLogger[Int, Unit] =
  msgLogger.contramap[Int](_.toString)
// intLogger: ZLogger[Int, Unit] = zio.ZLogger$$anon$2@102798f3
...
// warnLogger: ZLogger[String, Option[Unit]] = zio.ZLogger$$anon$3@425b231d
...
// sampleLine: String = "timestamp=2026-09-07T13:15:54.682306150Z level=INFO thread=#zio-fiber- message=\"something happened\""

// 5. Fan both loggers together; Zippable[String, Unit].Out = String
val combined: ZLogger[String, String] = ZLogger.default ++ msgLogger
// combined: ZLogger[String, String] = zio.ZLogger$$anon$1@26764c08
```
