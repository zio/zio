...
// msgLogger: ZLogger[String, Unit] = zio.ZLogger$$anon$6@668e878c

// 2. Adapt it to accept integers as messages
val intLogger: ZLogger[Int, Unit] =
  msgLogger.contramap[Int](_.toString)
// intLogger: ZLogger[Int, Unit] = zio.ZLogger$$anon$2@57d182e3
...
// warnLogger: ZLogger[String, Option[Unit]] = zio.ZLogger$$anon$3@3127adf8
...
// sampleLine: String = "timestamp=2026-09-07T10:35:07.916604388Z level=INFO thread=#zio-fiber- message=\"something happened\""

// 5. Fan both loggers together; Zippable[String, Unit].Out = String
val combined: ZLogger[String, String] = ZLogger.default ++ msgLogger
// combined: ZLogger[String, String] = zio.ZLogger$$anon$1@24a4e5a7
```
