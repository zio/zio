...
> How to interrupt a fiber in ZIO: Fiber#interrupt and its fire-and-forget variants, self-interruption, reading the interruptor's FiberId out of a Cause, and ZIO#disconnect.
