# Cached: Automatic and Manual Resource Caching

> Cached provides automatic and manual caching of expensive resourceful values with scheduled refresh policies and graceful error handling.
