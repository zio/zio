...
> Transform ZIO's error channel without recovering: map errors, chain on failures, filter successes, expose errors and causes in the success channel, convert defects to failures, refine error types, and more.
