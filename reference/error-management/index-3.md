...
> Recover from ZIO failures using catching, fallback, folding, retrying, timing out, and sandboxing — operators that work on typed errors, defects, and the full Cause graph.
