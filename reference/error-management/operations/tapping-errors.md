...
> Inspect ZIO failure values, defects, and Cause graphs as a side effect without altering the error channel, using tapError, tapErrorCause, tapDefect, tapBoth, and tapEither.
...
trait ZIO[-R, +E, +A] {
  ...
  def tapErrorTrace[R1 <: R, E1 >: E](f: ((E, StackTrace)) => ZIO[R1, E1, Any]): ZIO[R1, E1, A]
