...
> Learn about fatal errors in ZIO — VirtualMachineError and its subtypes on the JVM — that bypass all error handling operators and immediately terminate the application.
