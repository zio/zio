...
> Fold over ZIO effects to handle both success and failure in one step using fold, foldZIO, foldCause, and foldCauseZIO — the primitive all ZIO error operators build on.
