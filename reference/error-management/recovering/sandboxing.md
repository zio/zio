...
> Use ZIO's sandbox, unsandbox, and sandboxWith operators to expose and recover from the full Cause graph — including defects and interruptions — not just typed failures.
