...
> Collect all errors from a set of effects instead of short-circuiting on the first failure, using ZIO.validate, ZIO.validatePar, ZIO.validateFirst, and related combinators.
