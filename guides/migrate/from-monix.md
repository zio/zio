# Migrate from Monix to ZIO 2.x

> A comprehensive reference for mapping Monix 3.x Task, Coeval, Observable, TaskApp, Atomic, and monix.catnap to their ZIO 2.x equivalents
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/CompleteExample.scala"
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/monix/Step1EntryPoint.scala" showLineNumbers
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/Step1EntryPoint.scala" showLineNumbers
package migratefrommonix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/monix/Step2EffectConstructors.scala" showLineNumbers
package migratefrommonix.monix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/Step2EffectConstructors.scala" showLineNumbers
package migratefrommonix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/monix/Step3ErrorHandling.scala" showLineNumbers
package migratefrommonix.monix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/Step3ErrorHandling.scala" showLineNumbers
package migratefrommonix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/monix/Step4Resources.scala" showLineNumbers
package migratefrommonix.monix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/Step4Resources.scala" showLineNumbers
package migratefrommonix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/monix/Step5Concurrency.scala" showLineNumbers
package migratefrommonix.monix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/Step5Concurrency.scala" showLineNumbers
package migratefrommonix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/monix/Step6SharedState.scala" showLineNumbers
package migratefrommonix.monix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/Step6SharedState.scala" showLineNumbers
package migratefrommonix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/monix/Step7ConcurrentDataStructures.scala" showLineNumbers
package migratefrommonix.monix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/Step7ConcurrentDataStructures.scala" showLineNumbers
package migratefrommonix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/monix/Step8Streaming.scala" showLineNumbers
package migratefrommonix.monix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/Step8Streaming.scala" showLineNumbers
package migratefrommonix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/monix/Step9RunningUnsafely.scala" showLineNumbers
package migratefrommonix.monix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/Step9RunningUnsafely.scala" showLineNumbers
package migratefrommonix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/monix/Step10Testing.scala" showLineNumbers
package migratefrommonix.monix
...
```scala title="zio-examples/migrate-from-monix/src/main/scala/migratefrommonix/Step10Testing.scala" showLineNumbers
package migratefrommonix
