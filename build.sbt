...
lazy val core = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(buildInfoSettings("BuildInfoZio"))
...
lazy val coreTests = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(buildInfoSettings("BuildInfoZioTests"))
...
lazy val streams = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(buildInfoSettings("BuildInfoZioStreams"))
...
lazy val streamsTests = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(testFrameworks += new TestFramework("zio.test.sbt.ZTestFramework"))
  .settings(buildInfoSettings("BuildInfoZioStreamsTests"))
  .settings(streamReplSettings)
  .enablePlugins(BuildInfoPlugin)
...
lazy val stacktracer = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(buildInfoSettings("BuildInfoZioStacktracer"))
  .settings(
    libraryDependencies ++= Seq(
      "org.specs2" %%% "specs2-core"          % "4.7.1" % Test,
      "org.specs2" %%% "specs2-scalacheck"    % "4.7.1" % Test,
