...
lazy val docs = project.module
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.github.vigoo"               %% "zio-aws-core"                  % "3.17.21.1",
      "io.github.vigoo"               %% "zio-aws-ec2"                   % "3.17.21.1",
      "io.github.vigoo"               %% "zio-aws-elasticbeanstalk"      % "3.17.21.1",
      "io.github.vigoo"               %% "zio-aws-netty"                 % "3.17.21.1",
