...
lazy val commonJunitTestSettings = Seq(
  ...
  libraryDependencies ++= Seq(
    ...
    "org.apache.maven"          % "maven-embedder"                 % "3.9.15" % Test,
    "org.apache.maven"          % "maven-compat"                   % "3.9.15" % Test,
    "com.google.inject"         % "guice"                          % "6.0.0"  % Test,
    "org.eclipse.sisu"          % "org.eclipse.sisu.inject"        % "1.0.0"  % Test,
    "org.apache.maven.resolver" % "maven-resolver-connector-basic" % "2.0.17" % Test,
