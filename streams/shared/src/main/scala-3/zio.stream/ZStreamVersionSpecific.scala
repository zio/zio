...
trait ZStreamVersionSpecific[-R, +E, +O] { self: ZStream[R, E, O] =>
   ...
   * }}}
   */
  inline def injectCustom[E1 >: E](inline layer: ZLayer[_,E1,_]*): ZStream[ZEnv, E1, O] =
    ${ZStreamProvideMacro.injectImpl[ZEnv, R, E1, O]('self, 'layer)}
  ...
  inline def inject[E1 >: E](inline layer: ZLayer[_,E1,_]*): ZStream[Any, E1, O] =
    ${ZStreamProvideMacro.injectImpl[Any, R, E1, O]('self, 'layer)}
...
object ZStreamProvideMacro {
  ...
  def injectImpl[R0: Type, R: Type, E: Type, A: Type](zstream: Expr[ZStream[R,E,A]], layer: Expr[Seq[ZLayer[_,E,_]]])(using Quotes): Expr[ZStream[R0,E,A]] = {
