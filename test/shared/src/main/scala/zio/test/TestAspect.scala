...
object TestAspect extends TestAspectCompanionVersionSpecific with TimeoutVariants {
   ...
   * }}}
   */
  def provideCustom[E, R](layer: ZLayer[TestEnvironment, TestFailure[E], R])(implicit
    tagged: Tag[R],
    trace: ZTraceElement
  ): TestAspect.WithOut[
    ...
    provideSome[TestEnvironment][E, R](layer)
  ...
  def provideCustomServices[E, R](layer: ZLayer[TestEnvironment, TestFailure[E], R])(implicit
    tagged: Tag[R],
    trace: ZTraceElement
  ): TestAspect.WithOut[
    TestEnvironment with R,
  ...
  def provideCustomServicesShared[E, R](layer: ZLayer[TestEnvironment, TestFailure[E], R])(implicit
    tagged: Tag[R],
    trace: ZTraceElement
  ): TestAspect.WithOut[
    TestEnvironment with R,
   ...
   * }}}
   */
  def provideCustomShared[E, R](layer: ZLayer[TestEnvironment, TestFailure[E], R])(implicit
    tagged: Tag[R],
    trace: ZTraceElement
  ): TestAspect.WithOut[
    TestEnvironment with R,
    ...
    provideSomeShared[TestEnvironment][E, R](layer)
    ...
    def apply[E1, R1](
      ...
      new TestAspect[R0 with R1, Any, E1, Any] {
        ...
        def apply[R >: R0 with R1, E >: E1](
          ...
          spec.provide[TestFailure[E], R0, R0 with R1](ZLayer.environment[R0] ++ layer)
      }
  }
    ...
    def apply[E1, R1](
      ...
      new TestAspect[R0 with R1, Any, E1, Any] {
        ...
        def apply[R >: R0 with R1, E >: E1](
          ...
          spec.provideShared[TestFailure[E], R0, R0 with R1](ZLayer.environment[R0] ++ layer)
      }
  }
}
