...
final case class TestRunner[R, E](
  ...
  def unsafeRun(
    ...
    runtime.unsafeRun(run(spec).manuallyProvide(bootstrap))
  ...
  def unsafeRunAsync(
    ...
    runtime.unsafeRunAsyncWith(run(spec).manuallyProvide(bootstrap)) {
  ...
  def unsafeRunSync(
    ...
    runtime.unsafeRunSync(run(spec).manuallyProvide(bootstrap))
