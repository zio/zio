...
abstract class ZLaws[-Caps[_], -R] { self =>
   ...
   * generator.
   */
  def run[R1 <: R with TestConfig, A: Caps](gen: Gen[R1, A])(implicit
    trace: ZTraceElement
  ): ZIO[R1, Nothing, Assert]
...
object ZLaws {
  ...
  abstract class Law1[-Caps[_]](label: String) extends ZLaws[Caps, Any] { self =>
    def apply[A: Caps](a1: A): Assert
    final def run[R <: TestConfig, A: Caps](gen: Gen[R, A])(implicit trace: ZTraceElement): URIO[R, Assert] =
  ...
  abstract class Law1ZIO[-Caps[_], -R](label: String) extends ZLaws[Caps, R] { self =>
    def apply[A: Caps](a1: A): URIO[R, Assert]
    final def run[R1 <: R with TestConfig, A: Caps](gen: Gen[R1, A])(implicit
      trace: ZTraceElement
    ): ZIO[R1, Nothing, Assert] =
  ...
  abstract class Law2[-Caps[_]](label: String) extends ZLaws[Caps, Any] { self =>
    def apply[A: Caps](a1: A, a2: A): Assert
    final def run[R <: TestConfig, A: Caps](gen: Gen[R, A])(implicit trace: ZTraceElement): URIO[R, Assert] =
  ...
  abstract class Law2ZIO[-Caps[_], -R](label: String) extends ZLaws[Caps, R] { self =>
    def apply[A: Caps](a1: A, a2: A): URIO[R, Assert]
    final def run[R1 <: R with TestConfig, A: Caps](gen: Gen[R1, A])(implicit
      trace: ZTraceElement
    ): ZIO[R1, Nothing, Assert] =
  ...
  abstract class Law3[-Caps[_]](label: String) extends ZLaws[Caps, Any] { self =>
    def apply[A: Caps](a1: A, a2: A, a3: A): Assert
    final def run[R <: TestConfig, A: Caps](gen: Gen[R, A])(implicit trace: ZTraceElement): URIO[R, Assert] =
  ...
  abstract class Law3ZIO[-Caps[_], -R](label: String) extends ZLaws[Caps, R] { self =>
    def apply[A: Caps](a1: A, a2: A, a3: A): URIO[R, Assert]
    final def run[R1 <: R with TestConfig, A: Caps](gen: Gen[R1, A])(implicit
      trace: ZTraceElement
    ): ZIO[R1, Nothing, Assert] =
