...
import zio.test.{Gen, TestConfig, TestReturnValue, check, checkM}
import zio.{URIO, ZIO}
...
object ZLawsF {
  ...
  abstract class Covariant[-CapsF[_[+_]], -Caps[_], -R] { self =>
    ...
    def run[R1 <: R with TestConfig, F[+_]: CapsF, A: Caps](
      genF: GenF[R1, F],
      gen: Gen[R1, A]
    ): ZIO[R1, Nothing, TestReturnValue]
  ...
  object Covariant {
    ...
    abstract class ComposeLaw[-CapsF[_[+_]], -Caps[_]](label: String) extends Covariant[CapsF, Caps, Any] { self =>
      def apply[F[+_]: CapsF, A: Caps, B: Caps, C: Caps](fa: F[A], f: A => B, g: B => C): TestReturnValue
    ...
    abstract class FlattenLaw[-CapsF[_[+_]], -Caps[_]](label: String) extends Covariant[CapsF, Caps, Any] { self =>
      def apply[F[+_]: CapsF, A: Caps](fffa: F[F[F[A]]]): TestReturnValue
      final def run[R <: TestConfig, F[+_]: CapsF, A: Caps](
        genF: GenF[R, F],
        gen: Gen[R, A]
      ): URIO[R, TestReturnValue] =
    ...
    abstract class Law1[-CapsF[_[+_]], -Caps[_]](label: String) extends Covariant[CapsF, Caps, Any] { self =>
      def apply[F[+_]: CapsF, A: Caps](fa: F[A]): TestReturnValue
      final def run[R <: TestConfig, F[+_]: CapsF, A: Caps](
        genF: GenF[R, F],
        gen: Gen[R, A]
      ): URIO[R, TestReturnValue] =
    ...
    abstract class Law1M[-CapsF[_[+_]], -Caps[_], -R](label: String) extends Covariant[CapsF, Caps, R] { self =>
      def apply[F[+_]: CapsF, A: Caps](fa: F[A]): URIO[R, TestReturnValue]
      final def run[R1 <: R with TestConfig, F[+_]: CapsF, A: Caps](
        genF: GenF[R1, F],
        gen: Gen[R1, A]
      ): ZIO[R1, Nothing, TestReturnValue] =
        checkM(genF(gen))(apply(_).map(_.label(label)))
    }
    ...
    abstract class Law2[-CapsF[_[+_]], -Caps[_]](label: String) extends Covariant[CapsF, Caps, Any] { self =>
      def apply[F[+_]: CapsF, A: Caps, B: Caps](fa: F[A], fb: F[B]): TestReturnValue
      final def run[R <: TestConfig, F[+_]: CapsF, A: Caps](
        genF: GenF[R, F],
        gen: Gen[R, A]
      ): URIO[R, TestReturnValue] =
    ...
    abstract class Law2M[-CapsF[_[+_]], -Caps[_], -R](label: String) extends Covariant[CapsF, Caps, R] { self =>
      def apply[F[+_]: CapsF, A: Caps, B: Caps](fa: F[A], fb: F[B]): URIO[R, TestReturnValue]
      final def run[R1 <: R with TestConfig, F[+_]: CapsF, A: Caps](
        genF: GenF[R1, F],
        gen: Gen[R1, A]
      ): ZIO[R1, Nothing, TestReturnValue] =
        checkM(genF(gen), genF(gen))(apply(_, _).map(_.label(label)))
    }
    ...
    abstract class Law3[-CapsF[_[+_]], -Caps[_]](label: String) extends Covariant[CapsF, Caps, Any] { self =>
      def apply[F[+_]: CapsF, A: Caps, B: Caps, C: Caps](fa: F[A], fb: F[B], fc: F[C]): TestReturnValue
      final def run[R <: TestConfig, F[+_]: CapsF, A: Caps](
        genF: GenF[R, F],
        gen: Gen[R, A]
      ): URIO[R, TestReturnValue] =
    ...
    abstract class Law3M[-CapsF[_[+_]], -Caps[_], -R](label: String) extends Covariant[CapsF, Caps, R] { self =>
      def apply[F[+_]: CapsF, A: Caps, B: Caps, C: Caps](fa: F[A], fb: F[B], fc: F[C]): URIO[R, TestReturnValue]
      final def run[R1 <: R with TestConfig, F[+_]: CapsF, A: Caps](
        genF: GenF[R1, F],
        gen: Gen[R1, A]
      ): ZIO[R1, Nothing, TestReturnValue] =
        checkM(genF(gen), genF(gen), genF(gen))(apply(_, _, _).map(_.label(label)))
    }
  }
  ...
  object Contravariant {
    ...
    abstract class ComposeLaw[-CapsF[_[-_]], -Caps[_]](label: String) extends Contravariant[CapsF, Caps, Any] {
      self =>
      def apply[F[-_]: CapsF, A: Caps, B: Caps, C: Caps](fa: F[A], f: B => A, g: C => B): TestReturnValue
      final def run[R <: TestConfig, F[-_]: CapsF, A: Caps](
        genF: GenF[R, F],
        gen: Gen[R, A]
      ): URIO[R, TestReturnValue] =
  ...
  object Invariant {
    ...
    abstract class Law1[-CapsF[_[_]], -Caps[_]](label: String) extends Invariant[CapsF, Caps, Any] { self =>
      def apply[F[_]: CapsF, A: Caps](fa: F[A]): TestReturnValue
      final def run[R <: TestConfig, F[_]: CapsF, A: Caps](genF: GenF[R, F], gen: Gen[R, A]): URIO[R, TestReturnValue] =
        check(genF(gen))(apply(_).label(label))
    }
