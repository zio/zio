...
object Gen extends GenZIO with FunctionVariants with TimeVariants {
   ...
   */
  val anyHexChar: Gen[Random, Char] = weighted(
    char('\u0030', '\u0039') -> 10,
    char('\u0041', '\u0046') -> 6,
    char('\u0061', '\u0066') -> 6
  )
   ...
   */
  val anyLowerHexChar: Gen[Random, Char] = weighted(char('\u0030', '\u0039') -> 10, char('\u0061', '\u0066') -> 6)
   ...
   */
  val anyUpperHexChar: Gen[Random, Char] =
    weighted(
      char('\u0030', '\u0039') -> 10,
      char('\u0041', '\u0046') -> 6
    )
   ...
   * deterministic generator that generators all of the values generated by
