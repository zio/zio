...
//      }
  ...
  object ASTConverter {
    ...
    lazy val all: List[ASTConverter] = List(
      isEven,
      isOdd,
      equalTo,
      get,
    ...
    lazy val asInstance: ASTConverter =
      ASTConverter.make {
