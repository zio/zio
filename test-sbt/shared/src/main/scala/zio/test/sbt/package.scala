...
package object sbt {
  ...
  /**
   * Inserts the ANSI escape code for the current color at the beginning of each line of the specified string so the
   * string will be displayed with the correct color by the `SBTTestLogger`.
   */
