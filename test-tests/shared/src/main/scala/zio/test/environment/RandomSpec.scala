...
object RandomSpec extends AsyncBaseSpec {
  ...
  val run: List[Async[(Boolean, String)]] = List(
    ...
    label(forAllEqual(_.choose(Chunk.fromIterable(Vector.range(0, 100))))(_.nextInt(100)), "choose from chunk"),
    label(forAllEqual(_.choose(Range(0, 100)))(_.nextInt(100)), "choose"),
    label(forAllEqual(_.chooseByFrequency(Range(0, 10))(_ % 2))(_.nextInt(5) * 2 + 1), "chooseByFrequency"),
