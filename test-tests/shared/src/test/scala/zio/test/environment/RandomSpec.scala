...
object RandomSpec extends ZIOBaseSpec {
  ...
  def spec: Spec[Has[Random.Service] with Has[TestRandom.Service] with Has[TestClock.Service] with Has[
    TestConsole.Service
  ] with Has[TestRandom.Service] with Has[TestSystem.Service] with Has[Annotations.Service] with Has[
    TestConfig.Service
  ] with Has[Random.Service] with Has[Sized.Service] with Has[TestConfig.Service], TestFailure[Any], TestSuccess] =
    suite("RandomSpec")(
