...
//         val app  = ZIO.collectAllPar(Vector.fill(100)(ImpureModule.singleParam(1))).provideServices(mock)
...
//         val app = ZIO.collectAllPar(params.map(i => ImpureModule.singleParam(i))).provideServices(mock)
