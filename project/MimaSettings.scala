  ...
  def mimaSettings(failOnProblem: Boolean) =
    Seq(
      ...
      mimaBinaryIssueFilters ++= Seq(
        ...
        exclude[Problem]("zio.Queue#QueueImpl.shutdownCause"),
        exclude[Problem]("zio.Queue#QueueImpl.failOrInterrupt"),
        exclude[Problem]("zio.Queue#QueueImpl.shutdownCauseRef"),
        exclude[Problem]("zio.Queue#BackPressure.shutdownWithCause"),
        exclude[Problem]("zio.Queue#Strategy.shutdownWithCause"),
        exclude[Problem]("zio.Queue$$anon*.shutdownCause"),
