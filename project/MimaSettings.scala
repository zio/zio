  ...
  def mimaSettings(failOnProblem: Boolean) =
    Seq(
      ...
      mimaBinaryIssueFilters ++= Seq(
        ...
        exclude[IncompatibleMethTypeProblem]("zio.Queue#QueueImpl.this"),
        exclude[IncompatibleMethTypeProblem]("zio.Queue#Strategy.handleSurplus"),
        exclude[ReversedMissingMethodProblem]("zio.Queue#Strategy.handleSurplus"),
        exclude[IncompatibleMethTypeProblem]("zio.Queue#Strategy#BackPressure.handleSurplus"),
        exclude[IncompatibleMethTypeProblem]("zio.Queue#Strategy#Dropping.handleSurplus"),
        exclude[IncompatibleMethTypeProblem]("zio.Queue#Strategy#Sliding.handleSurplus"),
