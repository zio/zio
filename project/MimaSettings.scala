  ...
  def mimaSettings(failOnProblem: Boolean) =
    Seq(
      ...
      mimaBinaryIssueFilters ++= Seq(
        ...
        exclude[Problem]("zio.Promise$internal*"),
        exclude[Problem]("zio.Queue#Strategy*"),
        exclude[Problem]("zio.Queue$Strategy*"),
        exclude[Problem]("zio.Queue#QueueImpl*"),
        exclude[Problem]("zio.Queue$QueueImpl*"),
        exclude[ReversedMissingMethodProblem]("zio.Dequeue.shutdownCause"),
        exclude[ReversedMissingMethodProblem]("zio.Enqueue.shutdownCause"),
