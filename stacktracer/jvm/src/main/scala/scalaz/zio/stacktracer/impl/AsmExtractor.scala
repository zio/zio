 ...
 */
//final class AsmExtractorImpl extends LambdaExtractor {
//
//  override def extractSourceLocation(lambda: Function[_, _], cache: StackTraceCache): SourceLocation = {
...
//
//        SourceLocation(cv.sourcefile, name, "<anonclass>", cv.line)
//
...
//        val cv = new MethodSearchVisitor(sl.getImplMethodName, sl.getImplMethodSignature, Opcodes.ASM7)
//        reader.accept(cv, 0)
...
//        )
//
//        SourceLocation(cv.sourcefile, classString, dirtyCaller, cv.line)
//    }
