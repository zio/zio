...
//   object OldLady {
//     def contentsOfStomach: ZIO[OldLady, Nothing, List[String]] = ZIO.environmentWithZIO(_.get.contentsOfStomach)
...
//   object Spider {
//     def contentsOfStomach: ZIO[Spider, Nothing, List[String]] = ZIO.environmentWithZIO(_.get.contentsOfStomach)
