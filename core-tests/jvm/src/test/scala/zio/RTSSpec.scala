...
object RTSSpec extends ZIOBaseSpec {
  ...
  def spec: Spec[Has[zio.console.Console.Service] with Has[TestConsole.Service] with Has[Blocking.Service] with Has[
    TestClock.Service
  ] with Has[TestConsole.Service] with Has[TestRandom.Service] with Has[TestSystem.Service] with Has[
    Annotations.Service
  ] with Has[TestConfig.Service] with Has[Live.Service], TestFailure[Any], TestSuccess] =
